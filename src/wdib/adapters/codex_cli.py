...
def _prompt_from_work_order(work_order: dict[str, Any]) -> str:
    return (
        ...
        "1) systematic-debugging: for bugs/failures, find root cause before fixes.\n"
        "2) test-driven-development: for behavior/code changes, write or update tests first.\n"
        "3) verification-before-completion: run concrete verification commands before claiming success.\n"
